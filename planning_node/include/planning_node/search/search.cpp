...
void FindPoint::GetAllWaypoints(std::vector<std::vector<double>> wypts) {
    waypoints = wypts;
}

// set waypoint, its distance, and psi
void FindPoint::FindTargetPoint(geometry_msgs::PoseStamped fr_pose) {
...
int FindPoint::FindTowardPoint(int target_idx, geometry_msgs::PoseStamped fr_pose){
...
// void FindPoint::GetArcTanTerm(double _velocity) {
...
// /*
// double FindPoint::GetSteeringValue() {
...
// double FindPoint::SetSteer(geometry_msgs::PoseStamped _fr_pose, double _velocity) {
...
// double FindPoint::distance_m() {
//     return car_wypt_dist_m;
// }

// double FindPoint::steer_val() {
//     return steering_val;
// }

// void FindPoint::PrintValue() {
//     std::cout << 
